...
Model 2 achieves significantly lower perplexity, demonstrating the benefit of modeling alignment positions.

## Bidirectional Alignment

Both models are trained in two directions (English→Russian and Russian→English). Outputs are combined using:
...
```text
EN: since their articles appeared, the price of gold has moved up still further.
RU: с тех пор как вышли их статьи, стоимость золота повысилась еще больше.
